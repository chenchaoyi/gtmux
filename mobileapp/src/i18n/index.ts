...
const S: Dict = {
  ...
  scanHint: {en: 'Point at the pairing QR on your Mac', zh: '对准 Mac 上的配对二维码'},
  cameraDenied: {en: 'Camera access denied. Enter the Mac manually instead.', zh: '相机权限被拒绝,请改用手动输入。'},
  noCamera: {en: 'No camera available (use a real device).', zh: '没有可用相机(请用真机)。'},
