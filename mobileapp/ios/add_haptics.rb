# Adds Haptics.swift + Haptics.m to the GtmuxMobile app target so the long-press
# impact compiles in. Idempotent — safe to re-run.
require 'xcodeproj'
...
%w[Haptics.swift Haptics.m].each do |name|
