# Adds HQMemory.swift + HQMemory.m to the GtmuxMobile app target so the
# supervisor-memory native module compiles in. Idempotent — safe to re-run.
require 'xcodeproj'
...
%w[HQMemory.swift HQMemory.m].each do |name|
