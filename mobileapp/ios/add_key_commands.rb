# Adds KeyCommands.swift + KeyCommands.m to the GtmuxMobile app target so the
# hardware-keyboard bridge compiles in. Idempotent — safe to re-run.
require 'xcodeproj'
...
%w[KeyCommands.swift KeyCommands.m].each do |name|
