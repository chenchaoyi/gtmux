...
SHOTS = [
    dict(name="01", accent=RED, cap=dict(en="See who needs you", zh="一眼看到谁在等你"),
         ...
         capture="01-radar"),
    dict(name="02", accent=CYAN, cap=dict(en="Full control from your phone", zh="手机上完整掌控"),
         sub=dict(en="Reply, send a command, take over any terminal — a full remote for your Mac.",
                  zh="回话、发命令、接管任意终端，你 Mac 的完整远程遥控。"),
         capture="02-terminal-approval"),
    dict(name="03", accent=GREEN, cap=dict(en="Switch between your Macs", zh="不同 Mac，随时切换"),
         sub=dict(en="Your MacBook, the studio Mac, even one a teammate shares.",
                  zh="你的 MacBook、工作室那台，还有同事共享给你的。"),
         capture="04-servers"),
    dict(name="04", accent=RED, cap=dict(en="An HQ triages the rest", zh="中控替你分诊"),
         sub=dict(en="A supervisor watches the fleet and surfaces only what matters.",
                  zh="参谋长盯着全舰队，只把要紧的推给你。"),
         capture="03-hq"),
    dict(name="05", accent=RED, cap=dict(en="Pinged when it needs you", zh="该你出手时才提醒"),
         sub=dict(en="Reply 1·2·3 straight from the notification.",
                  zh="通知上直接 1·2·3 回应。"),
         mockup=notify_mockup),
    dict(name="06", accent=CYAN, cap=dict(en="Live on your Lock Screen", zh="锁屏实时可见"),
