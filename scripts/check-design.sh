...
HIDDEN=" tunnel-client save-tab-order options app oneshot-run server-mode uninstall-hooks uninstall-app "   # internal plumbing + back-compat aliases, not user commands
